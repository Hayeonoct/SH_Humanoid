...
// IWYU pragma: private, include "ros2_interfaces/msg/upper_body_system_state.h"
...
enum
{
  ros2_interfaces__msg__UpperBodySystemState__MODE_IMPEDANCE = 0
};

/// Constant 'MODE_POSITION'.
enum
{
  ros2_interfaces__msg__UpperBodySystemState__MODE_POSITION = 1
};
...
enum
{
  ros2_interfaces__msg__UpperBodySystemState__MODE_TORQUE = 3
};

/// Constant 'MODE_POSITION_ALT'.
enum
{
  ros2_interfaces__msg__UpperBodySystemState__MODE_POSITION_ALT = 5
};
