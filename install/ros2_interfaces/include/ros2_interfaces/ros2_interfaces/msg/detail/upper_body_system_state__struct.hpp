...
// IWYU pragma: private, include "ros2_interfaces/msg/upper_body_system_state.hpp"
...
struct UpperBodySystemState_
{
  ...
  static constexpr uint8_t MODE_TORQUE =
    3u;
  static constexpr uint8_t MODE_POSITION_ALT =
    5u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t UpperBodySystemState_<ContainerAllocator>::MODE_POSITION_ALT;
#endif  // __cplusplus < 201703L
