...
class Init_EnableMotors_Event_response
{
public:
  explicit Init_EnableMotors_Event_response(::ros2_interfaces::srv::EnableMotors_Event & msg)
  : msg_(msg)
  {}
  ::ros2_interfaces::srv::EnableMotors_Event response(::ros2_interfaces::srv::EnableMotors_Event::_response_type arg)
  {
...
private:
  ::ros2_interfaces::srv::EnableMotors_Event msg_;
};

class Init_EnableMotors_Event_request
{
public:
  explicit Init_EnableMotors_Event_request(::ros2_interfaces::srv::EnableMotors_Event & msg)
  : msg_(msg)
  {}
  Init_EnableMotors_Event_response request(::ros2_interfaces::srv::EnableMotors_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_EnableMotors_Event_response(msg_);
  }
...
class Init_EnableMotors_Event_info
{
public:
  Init_EnableMotors_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_EnableMotors_Event_request info(::ros2_interfaces::srv::EnableMotors_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_EnableMotors_Event_request(msg_);
  }
...
template<>
inline
auto build<::ros2_interfaces::srv::EnableMotors_Event>()
{
  return ros2_interfaces::srv::builder::Init_EnableMotors_Event_info();
}
