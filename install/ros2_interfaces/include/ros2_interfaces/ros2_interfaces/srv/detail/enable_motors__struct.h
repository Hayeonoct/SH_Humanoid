...
enum
{
  ros2_interfaces__srv__EnableMotors_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ros2_interfaces__srv__EnableMotors_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/EnableMotors in the package ros2_interfaces.
typedef struct ros2_interfaces__srv__EnableMotors_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ros2_interfaces__srv__EnableMotors_Request__Sequence request;
  ros2_interfaces__srv__EnableMotors_Response__Sequence response;
} ros2_interfaces__srv__EnableMotors_Event;

// Struct for a sequence of ros2_interfaces__srv__EnableMotors_Event.
typedef struct ros2_interfaces__srv__EnableMotors_Event__Sequence
{
