...
class Metaclass_UpperBodySystemState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'MODE_POSITION_ALT': cls.__constants['MODE_POSITION_ALT'],
        }
    ...
    @property
    def MODE_POSITION_ALT(self):
        """Message constant 'MODE_POSITION_ALT'."""
        return Metaclass_UpperBodySystemState.__constants['MODE_POSITION_ALT']
