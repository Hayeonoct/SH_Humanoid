...
class Metaclass_EnableMotors_Event(type):
    """Metaclass of message 'EnableMotors_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__enable_motors__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__enable_motors__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__enable_motors__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__enable_motors__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__enable_motors__event
...
class EnableMotors_Event(metaclass=Metaclass_EnableMotors_Event):
    """Message class 'EnableMotors_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros2_interfaces/EnableMotors_Request, 1>',
        'response': 'sequence<ros2_interfaces/EnableMotors_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interfaces', 'srv'], 'EnableMotors_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_interfaces', 'srv'], 'EnableMotors_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2_interfaces.srv import EnableMotors_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, EnableMotors_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'EnableMotors_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ros2_interfaces.srv import EnableMotors_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, EnableMotors_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'EnableMotors_Response'"
...
class Metaclass_EnableMotors(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _enable_motors.Metaclass_EnableMotors_Event._TYPE_SUPPORT is None:
                _enable_motors.Metaclass_EnableMotors_Event.__import_type_support__()
...
class EnableMotors(metaclass=Metaclass_EnableMotors):
    ...
    from ros2_interfaces.srv._enable_motors import EnableMotors_Event as Event
