...
inline std::string to_yaml(const EnableMotors_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ros2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros2_interfaces::srv::EnableMotors_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ros2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const ros2_interfaces::srv::EnableMotors_Event & msg)
{
  return ros2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ros2_interfaces::srv::EnableMotors_Event>()
{
  return "ros2_interfaces::srv::EnableMotors_Event";
}

template<>
inline const char * name<ros2_interfaces::srv::EnableMotors_Event>()
{
  return "ros2_interfaces/srv/EnableMotors_Event";
}

template<>
struct has_fixed_size<ros2_interfaces::srv::EnableMotors_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ros2_interfaces::srv::EnableMotors_Event>
  : std::integral_constant<bool, has_bounded_size<ros2_interfaces::srv::EnableMotors_Request>::value && has_bounded_size<ros2_interfaces::srv::EnableMotors_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ros2_interfaces::srv::EnableMotors_Event>
  : std::true_type {};
