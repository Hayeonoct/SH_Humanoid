...
ros2_interfaces__msg__UpperMotorState__create(void)
{
...
ros2_interfaces__msg__UpperMotorState__Sequence__init(ros2_interfaces__msg__UpperMotorState__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(ros2_interfaces__msg__UpperMotorState)) {
      return false;
    }
  ...
  ros2_interfaces__msg__UpperMotorState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(ros2_interfaces__msg__UpperMotorState)) {
      return false;
    }
