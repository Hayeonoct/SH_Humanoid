...
void SimpleMotorResult_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) ros2_interfaces::srv::SimpleMotorResult_Event(_init);
}

void SimpleMotorResult_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_interfaces::srv::SimpleMotorResult_Event *>(message_memory);
  typed_message->~SimpleMotorResult_Event();
}

size_t size_function__SimpleMotorResult_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<ros2_interfaces::srv::SimpleMotorResult_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SimpleMotorResult_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<ros2_interfaces::srv::SimpleMotorResult_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__SimpleMotorResult_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<ros2_interfaces::srv::SimpleMotorResult_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__SimpleMotorResult_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ros2_interfaces::srv::SimpleMotorResult_Request *>(
    get_const_function__SimpleMotorResult_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<ros2_interfaces::srv::SimpleMotorResult_Request *>(untyped_value);
  value = item;
}

void assign_function__SimpleMotorResult_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ros2_interfaces::srv::SimpleMotorResult_Request *>(
    get_function__SimpleMotorResult_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const ros2_interfaces::srv::SimpleMotorResult_Request *>(untyped_value);
  item = value;
}

void resize_function__SimpleMotorResult_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<ros2_interfaces::srv::SimpleMotorResult_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__SimpleMotorResult_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<ros2_interfaces::srv::SimpleMotorResult_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SimpleMotorResult_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<ros2_interfaces::srv::SimpleMotorResult_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__SimpleMotorResult_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<ros2_interfaces::srv::SimpleMotorResult_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__SimpleMotorResult_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ros2_interfaces::srv::SimpleMotorResult_Response *>(
    get_const_function__SimpleMotorResult_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<ros2_interfaces::srv::SimpleMotorResult_Response *>(untyped_value);
  value = item;
}

void assign_function__SimpleMotorResult_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ros2_interfaces::srv::SimpleMotorResult_Response *>(
    get_function__SimpleMotorResult_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const ros2_interfaces::srv::SimpleMotorResult_Response *>(untyped_value);
  item = value;
}

void resize_function__SimpleMotorResult_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<ros2_interfaces::srv::SimpleMotorResult_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SimpleMotorResult_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_interfaces::srv::SimpleMotorResult_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ros2_interfaces::srv::SimpleMotorResult_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(ros2_interfaces::srv::SimpleMotorResult_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__SimpleMotorResult_Event__request,  // size() function pointer
    get_const_function__SimpleMotorResult_Event__request,  // get_const(index) function pointer
    get_function__SimpleMotorResult_Event__request,  // get(index) function pointer
    fetch_function__SimpleMotorResult_Event__request,  // fetch(index, &value) function pointer
    assign_function__SimpleMotorResult_Event__request,  // assign(index, value) function pointer
    resize_function__SimpleMotorResult_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ros2_interfaces::srv::SimpleMotorResult_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(ros2_interfaces::srv::SimpleMotorResult_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__SimpleMotorResult_Event__response,  // size() function pointer
    get_const_function__SimpleMotorResult_Event__response,  // get_const(index) function pointer
    get_function__SimpleMotorResult_Event__response,  // get(index) function pointer
    fetch_function__SimpleMotorResult_Event__response,  // fetch(index, &value) function pointer
    assign_function__SimpleMotorResult_Event__response,  // assign(index, value) function pointer
    resize_function__SimpleMotorResult_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers SimpleMotorResult_Event_message_members = {
  "ros2_interfaces::srv",  // message namespace
  "SimpleMotorResult_Event",  // message name
  3,  // number of fields
  sizeof(ros2_interfaces::srv::SimpleMotorResult_Event),
  false,  // has_any_key_member_
  SimpleMotorResult_Event_message_member_array,  // message members
  SimpleMotorResult_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  SimpleMotorResult_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t SimpleMotorResult_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &SimpleMotorResult_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<ros2_interfaces::srv::SimpleMotorResult_Event>()
{
  return &::ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::SimpleMotorResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interfaces, srv, SimpleMotorResult_Event)() {
  return &::ros2_interfaces::srv::rosidl_typesupport_introspection_cpp::SimpleMotorResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SimpleMotorResult_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ros2_interfaces::srv::SimpleMotorResult_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ros2_interfaces::srv::SimpleMotorResult_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ros2_interfaces::srv::SimpleMotorResult_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<ros2_interfaces::srv::SimpleMotorResult>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<ros2_interfaces::srv::SimpleMotorResult>,
...
get_service_type_support_handle<ros2_interfaces::srv::SimpleMotorResult>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::ros2_interfaces::srv::SimpleMotorResult_Event
      >()->data
      );
  }
