...
bool cdr_serialize_ros2_interfaces__msg__UpperMotorState(
  const ros2_interfaces__msg__UpperMotorState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interfaces
bool cdr_deserialize_ros2_interfaces__msg__UpperMotorState(
  eprosima::fastcdr::Cdr & cdr,
  ros2_interfaces__msg__UpperMotorState * ros_message)
{
  // Field name: header
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interfaces__msg__UpperMotorState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interfaces
bool cdr_serialize_key_ros2_interfaces__msg__UpperMotorState(
  const ros2_interfaces__msg__UpperMotorState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interfaces
size_t get_serialized_size_key_ros2_interfaces__msg__UpperMotorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UpperMotorState__ros_msg_type * ros_message = static_cast<const _UpperMotorState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_interfaces
size_t max_serialized_size_key_ros2_interfaces__msg__UpperMotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2_interfaces__msg__UpperMotorState * ros_message = static_cast<const ros2_interfaces__msg__UpperMotorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2_interfaces__msg__UpperMotorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2_interfaces__msg__UpperMotorState * ros_message = static_cast<ros2_interfaces__msg__UpperMotorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2_interfaces__msg__UpperMotorState(cdr, ros_message);
}
